...
const firstHalfSecond = fs.readdirSync(
  __dirname + "/public/artsPortfolio/firstHalfSecond"
);
const secondHalfSecond = fs.readdirSync(
  __dirname + "/public/artsPortfolio/secondHalfSecond"
);
...
const projectList = list.map(i => {
  const { name, tech, desc, web } = require(__dirname +
    "/projects/" +
    i +
    "/info");
  return {
...
const bigProjectList = require(__dirname +
  "/public/bigProjectList/bigProjectList.json");
